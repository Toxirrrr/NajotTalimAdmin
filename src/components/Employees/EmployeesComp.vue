...
import { getAll, deleteManager, editManager, addManager, getByid, searchUsers } from '@/Services/ManagerService';
...
const editRow = async (index) => {
    ...
    console.log(components.getById);
        ...
        <div v-if="edit__user" class="delete__modal">
            <div class="modal__wrapper">
                ...
                <div class="modal__text-wrapper add">
                    <label class="modal__label">
                        Фамилия
                        <input class="modal__input" type="email" v-model="editableUser.lastName" @focus="selectAllText"
                            placeholder="Введите фамилию">
                    </label>
                    <label class="modal__label">
                        Имя
                        <input class="modal__input" type="email" v-model="editableUser.firstName" @focus="selectAllText"
                            placeholder="Введите имя">
                    </label>
                    <label class="modal__label" for="userType">Hodim Turi:
