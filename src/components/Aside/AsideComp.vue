                ...
                <ul class="aside__bottom-list">
                    ...
                    <li class="aside__item">
                        <router-link to="/subscription" class="aside__link">
                            ...
                            <p class="aside__text">Subscription</p>
                        </router-link>
                    </li>
                </ul>
            </aside>
